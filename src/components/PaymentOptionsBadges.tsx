...
function BadgeButton({
  ...
  return (
    ...
    >
      ...
      <span className="block w-full text-justify text-[12.5px] leading-snug text-[#071426] [text-align-last:right] sm:inline sm:min-w-0 sm:flex-1 sm:text-left sm:[text-align-last:auto]">{children}</span>
