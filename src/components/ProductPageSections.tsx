  ...
  return (
    <section className="mt-12 md:mt-20">
      ...
      <div className="overflow-x-auto scrollbar-hide">
        <div className="flex h-[420px] gap-3 md:h-[560px] md:gap-4">
          ...
          {BUILT_TO_LAST_CARDS.map((card, i) => (
            ...
            >
              ...
              >
                ...
                <p
                  className="mt-[11px] md:mt-3 max-w-[240px] text-[13px] md:text-[14px] leading-[1.38] font-light tracking-[0.015em]"

                  style={{ color: card.textColor, opacity: card.textColor ? 1 : undefined, maxWidth: card.bodyMaxWidth, fontWeight: 330 }}
                >
                  {card.body}
                </p>
              </div>
...
export function NewsletterContactSection() {
  ...
  const contactItems = [
    ...
    { icon: Mail, label: "Stuur een mail", sub: "iedere werkdag", value: "support@wandig.com", href: "mailto:support@wandig.com" },
  ];
