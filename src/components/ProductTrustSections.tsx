...
const FAQ_ITEMS: Array<{ question: string; answer: string }> = [
  {
    ...
    answer:
      "De Wandig Full House is 240 cm breed, 180 cm hoog en 32 cm diep. Het centrale tv-vlak is geschikt voor televisies tot 80 inch.",
  },
  {
    question: "Hoe lang duurt de levering?",
    answer:
      "Standaard leveren we binnen 10 werkdagen. Je ontvangt van ons een bericht zodra je tv-wand onderweg is.",
  },
  {
    question: "Kan ik de cinewall zelf monteren?",
    answer:
      "Ja, de cinewall wordt plug & play geleverd. Met de meegeleverde handleiding zet je hem samen met iemand anders eenvoudig in elkaar.",
  },
  {
    question: "Passen mijn kabels en apparatuur erin?",
    answer:
      "Achter het tv-vlak en in de gesloten kastruimte is voldoende plek voor kabels, een soundbar en mediaspelers.",
  },
  {
    question: "Kan ik de kleur thuis bekijken?",
    answer: "Ja, je kunt gratis kleurstalen aanvragen zodat je de kleur rustig in je eigen interieur kunt bekijken.",
  },
  {
    question: "Wat als de tv-wand niet bevalt?",
    answer: "Je hebt 100 dagen proefkijken. Bevalt het niet, dan nemen we de tv-wand kosteloos terug.",
  },
  {
    question: "Heb ik speciaal gereedschap nodig?",
    answer:
      "Nee, voor de montage heb je alleen basisgereedschap zoals een schroevendraaier en een boormachine nodig.",
  },
  {
