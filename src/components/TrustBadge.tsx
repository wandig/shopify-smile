...
/**
 * Vast, puur visueel keurmerk-embleem.
 * Op mobiel linksboven, op desktop linksonder.
...
export function TrustBadge() {
  ...
  return (
    <div className="pointer-events-none fixed top-3 left-3 z-30 md:bottom-4 md:left-4 md:top-auto">
