...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Wandig — Plug & play TV cinewalls" },
      { name: "description", content: "Tijdloze plug & play TV cinewalls uit eigen werkplaats. Gratis levering, 5 jaar garantie." },
      { property: "og:title", content: "Wandig — Plug & play TV cinewalls" },
      { property: "og:description", content: "Tijdloze plug & play TV cinewalls uit eigen werkplaats. Gratis levering, 5 jaar garantie." },
      { property: "og:type", content: "website" },
      { property: "og:locale", content: "nl_NL" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Wandig — Plug & play TV cinewalls" },
      { name: "twitter:description", content: "Tijdloze plug & play TV cinewalls uit eigen werkplaats. Gratis levering, 5 jaar garantie." },
      ...
      <body>
        ...
        <noscript>
          <img
            ...
            width="1"
            style={{ display: "none" }}
            src="https://www.facebook.com/tr?id=1654933889573926&ev=PageView&noscript=1"
          />
        </noscript>
        {children}
        <Scripts />
