      ...
      <div className="w-full">
        <div className="relative grid w-full items-start overflow-hidden bg-[#e9e3dc] lg:min-h-[calc(85vh-39px)] lg:grid-cols-[minmax(0,1fr)_528px] lg:py-[30px]">
          ...
          >
            ...
            {/* Configuration */}
            <div className="relative z-[3] flex w-full max-w-[1200px] origin-top translate-y-0 scale-[0.513] items-end justify-center md:translate-y-[10%] md:scale-[0.707] lg:translate-y-[-4.37%] lg:scale-[0.644] xl:scale-[0.811] 2xl:scale-[0.873]">
