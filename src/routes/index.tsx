...
function ModelCard({ p }: { p: (typeof PRODUCTS)[number] }) {
  ...
  return (
    <Link
      to="/product/$handle"
      params={{ handle: p.handle }}
      className="group flex h-full w-[280px] shrink-0 snap-start flex-col overflow-hidden rounded-[16px] bg-[#e7e3dd] p-3 shadow-[0_2px_10px_rgba(42,31,22,0.06)] md:w-[32%]"
    >
