  ...
  if (p.featured) {
    return (
      <Link
        ...
        className="group flex h-full w-[360px] shrink-0 snap-start flex-col overflow-hidden rounded-[16px] bg-[#faf8f6] p-3 shadow-[0_2px_10px_rgba(42,31,22,0.06)] md:w-[46%]"
      >
